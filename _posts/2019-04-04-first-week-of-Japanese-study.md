...
在日语里, 对长辈、工作单位的上司等应该尊重的对象, 或初次见面的人以及交往不多的人, 一般使用礼貌语言。在会议或举行某种仪式等公开场合也是如此。

将"子の/その/あの　人"变为"この/その/あの　方", 即成为一种礼貌语言。

> あの　方は　田中さんです。

另外, 用"JC企画の人ですか。"直接询问, 听起来会觉得对人不尊敬。用"JC企画の方ですか。"询问比较礼貌

### 询问年龄 [礼貌语言]

询问年龄时, 用"**何歳ですか**(多大了？)", 或者用比较礼貌的语言"**おいくつですか**(多大年龄了？)"。不论所问及的人年龄多大, 都可以使用。不过, 在直接询问孩子的年龄时, 一般用"おいくつ?"或"何歳?"
...
"ええ"是"はい"的比较随便的说法, 但只用于肯定对方的提问。在别人叫到自己的名字而应答是, 必须用"はい"
